...
object TreatmentData {
    val list = listOf(
        ...
        Treatment("SKINTIFIC Moist (Produk)",   150_000.0,   TreatmentCategory.PRODUCT),
        Treatment("Dior Rouge Dior Lipstick",   840_000.0,   TreatmentCategory.PRODUCT),
        Treatment("Almond Croissant Facial",    1_500_000.0, TreatmentCategory.FACIAL),
    )
}